...
var migrate = function migrate(data, migrations) {
  ...
  while (version < toVersion) {
    ...
    data = immer.produce(data, migrator);
    ...
    return Object.keys(current).forEach(function (key) {
      ...
      if (value != null && typeof value === 'object') {
        if (value[actionSymbol] || value[actionOnSymbol]) {
          var def = _objectSpread__default["default"]({}, value);
          ...
          var _def = _objectSpread__default["default"]({}, value);
          ...
          var _def2 = _objectSpread__default["default"]({}, value);
